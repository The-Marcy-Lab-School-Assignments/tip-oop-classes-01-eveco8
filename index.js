...
class Task {
 ...
 constructor(title, priority) {
    ...
    Task.allTasks.push(this); //push the object
 }
 //Getters
  get completedStatus() {
 ...
 //static Methods
static getTotalTasks() { //call the class itself when using static
   return Task.allTasks.length
}
static findByTitle(title) {
    return Task.allTasks.find(task => task.title === title)  /* each element is an object with title property */
}
}
